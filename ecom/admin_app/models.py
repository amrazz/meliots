...
class Product(models.Model):
    ...
    percentage = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(100)], default = 0)
...
class ProductColorImage(models.Model):
    product = models.ForeignKey(Product, related_name='color_image', on_delete=models.CASCADE)
...
class ProductSize(models.Model):
    productcolor = models.ForeignKey(ProductColorImage, related_name='size', on_delete=models.CASCADE)
    ...
    def __str__(self):
        ...
        return f"{product_name} - {self.size}"

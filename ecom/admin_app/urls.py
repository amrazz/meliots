...
urlpatterns = [
    ...
    path(
        ...
        views.product_is_deleted,
        name="product_is_deleted",
    ),
    path(
        "product_restore/<int:product_id>/",
        views.product_restore,
        name="product_restore",
    ),
    path("product_recycle_bin/", views.product_recycle_bin, name="product_recycle_bin"),
    path(
        "product_is_listed/<int:product_id>/",
        views.product_is_listed,
        name="product_is_listed",
    ),
    path(
        "product_is_unlisted/<int:product_id>/",
        views.product_is_unlisted,
        name="product_is_unlisted",
    ),
